...
#
# Will will attempt to create a new or edit an existing A or AAAA record for the given
# domain and subdomain. Existing CNAME and ALIAS records WILL NOT BE EDITED OR DELETED!
# "username" and "password" configurations should be set to Porkbun API key and secret
# key, respectively.
#
...
local __API __DOMAIN_REGEX __DOMAIN __SUBDOMAIN __ADDR __TYPE __ID
